    ...
    return (
        <div className="flex flex-col gap-2 text-[15px] leading-5 text-gray-700">
            ...
            <p>
                ...
                sayfalar (‘site’) ……………………… adresindeki ……………………………….firmasının
                (Firma) malıdır ve onun tarafından işletilir. Sizler
                (‘Kullanıcı’) sitede sunulan tüm hizmetleri kullanırken
                aşağıdaki şartlara tabi olduğunuzu, sitedeki hizmetten
            ...
            <p>
                a.Firma, fiyatlar ve sunulan ürün ve hizmetler üzerinde
            ...
            <p>
                ...
                içerikler üretmeyeceğini, paylaşmayacağını kabul eder. Aksi
            ...
            <p>
                ...
                bilgileri 3. Kişilere açıklamayacaktır. Bu kişisel bilgiler;
                kişi adı-soyadı, adresi, telefon numarası, cep telefonu, e-posta
                adresi gibi Kullanıcı’yı tanımlamaya yönelik her türlü diğer
            ...
            <p>
                ...
                iletişim, portföy durumu ve demografik bilgilerini iştirakleri
                ya da bağlı bulunduğu grup şirketleri ile paylaşmasına muvafakat
                ettiğini kabul ve beyan eder. Bu kişisel bilgiler firma
                bünyesinde müşteri profili belirlemek, müşteri profiline uygun
                promosyon ve kampanyalar sunmak ve istatistiksel çalışmalar
            ...
            <br />
            <p>
                4. Garanti Vermeme: İŞBU SÖZLEŞME MADDESİ UYGULANABİLİR KANUNUN
                İZİN VERDIGI AZAMİ ÖLÇÜDE GEÇERLİ OLACAKTIR. FİRMA TARAFINDAN
                SUNULAN HİZMETLER &quot;OLDUĞU GİBİ” VE &quot;MÜMKÜN OLDUĞU”
                TEMELDE SUNULMAKTA VE PAZARLANABİLİRLİK, BELİRLİ BİR AMACA
                UYGUNLUK VEYA İHLAL ETMEME KONUSUNDA TÜM ZIMNİ GARANTİLER DE
                DÂHİL OLMAK ÜZERE HİZMETLER VEYA UYGULAMA İLE İLGİLİ OLARAK
                (BUNLARDA YER ALAN TÜM BİLGİLER DÂHİL) SARİH VEYA ZIMNİ, KANUNİ
                VEYA BAŞKA BİR NİTELİKTE HİÇBİR GARANTİDE BULUNMAMAKTADIR.
            </p>
            <br />
            <h2 className="text-lg font-extrabold text-gray-900">
                5. Kayıt ve Güvenlik
            ...
            <p>
                ...
                gibi sebeplerden (aşağıda birlikte &quot;Mücbir Sebep&quot;
                olarak anılacaktır.) dolayı sözleşmeden doğan yükümlülükler
                taraflarca ifa edilemez hale gelirse, taraflar bundan sorumlu
                değildir. Bu sürede Taraflar’ın işbu Sözleşme’den doğan hak ve
            ...
            <p>
                ...
                çıkabilecek her türlü uyuşmazlıklarda Taraflar’ın defter, kayıt
