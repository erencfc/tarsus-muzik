...
export default function AboutPage() {
    return (
        <div className="flex flex-col gap-2 text-[15px] leading-5 text-gray-700">
            ...
            <h2 className="text-lg font-extrabold text-gray-900">1.TARAFLAR</h2>
            <p>
                İşbu Sözleşme aşağıdaki taraflar arasında aşağıda belirtilen
                hüküm ve şartlar çerçevesinde imzalanmıştır.
            </p>
            <p>
                <span className="font-extrabold text-gray-900">A.</span> ‘ALICI’{" "}
            ...
            <h2 className="text-lg font-extrabold text-gray-900">2.TANIMLAR</h2>
            <p>
            ...
            <p>
                SATICI : Ticari veya mesleki faaliyetleri kapsamında tüketiciye
                mal sunan veya mal sunan adına veya hesabına hareket eden
                şirketi,
            </p>
            <p>
            ...
            <h2 className="text-lg font-extrabold text-gray-900">3.KONU</h2>
            <p>
                ...
                ile ilgili olarak 6502 sayılı Tüketicinin Korunması Hakkında
            ...
            <p>
                <span className="font-extrabold text-gray-900">1.</span> Malın{" "}
            ...
            <p>
                <span className="font-extrabold text-gray-900">7.2.</span>{" "}
                Listelenen ve sitede ilan edilen fiyatlar satış fiyatıdır. İlan
                edilen fiyatlar ve vaatler güncelleme yapılana ve değiştirilene
                kadar geçerlidir. Süreli olarak ilan edilen fiyatlar ise
                belirtilen süre sonuna kadar geçerlidir.
            ...
            <p>
                <span className="font-extrabold text-gray-900">7.3.</span>{" "}
                Sözleşme konusu mal ya da hizmetin tüm vergiler dâhil satış
                fiyatı aşağıda gösterilmiştir.
            </p>
            <table cellPadding={0} cellSpacing={1} className="my-6 w-full">
                <colgroup>
                    <col width={133} />
                    <col width={21} />
                    <col width={51} />
                ...
                <tbody>
                    <tr>
                        <td className="w-[52%] border-4 border-double border-gray-700 p-0">
                            <p>Ürün Açıklaması</p>
                        </td>
                        <td className="w-[8%] border-4 border-double border-gray-700 p-0">
                            <p>Adet</p>
                        </td>
                        <td className="w-[20%] border-4 border-double border-gray-700 p-0">
                            <p>Birim Fiyatı</p>
                        </td>
                        <td
                            colSpan={2}
                            className="w-[20%] border-4 border-double border-gray-700 p-0"
                        >
                            <p>
                                Ara Toplam <br />
                                (KDV Dahil)
                    ...
                    <tr>
                        <td
                            colSpan={4}
                            className="w-[80%] border-4 border-double border-gray-700 p-0"
                        >
            ...
            <p>
                <span className="font-extrabold text-gray-900">7.4.</span> Ürün
            ...
            <p>
                ...
                adresine sipariş ile birlikte <br />
                teslim edilecektir.
            </p>
            <h2 className="text-lg font-extrabold text-gray-900">
                9. GENEL HÜKÜMLER
            ...
            <p>
                <span className="font-extrabold text-gray-900">9.1.</span>{" "}
                ...
                ALICI’nın; Ön Bilgilendirmeyi elektronik ortamda teyit etmesi,
            ...
            <p>
                <span className="font-extrabold text-gray-900">9.2.</span>{" "}
                Sözleşme konusu her bir ürün, 30 günlük yasal süreyi aşmamak
                kaydı ile ALICI&apos; nın yerleşim yeri uzaklığına bağlı olarak
                internet sitesindeki ön bilgiler kısmında belirtilen süre
                zarfında ALICI veya ALICI’nın gösterdiği adresteki kişi ve/veya
                kuruluşa teslim edilir. Bu süre içinde ürünün ALICI’ya teslim
                edilememesi durumunda, ALICI’nın sözleşmeyi feshetme hakkı
                saklıdır.
            </p>
            <p>
                <span className="font-extrabold text-gray-900">9.3.</span>{" "}
                SATICI, Sözleşme konusu ürünü eksiksiz, siparişte belirtilen
                niteliklere uygun ve varsa garanti belgeleri, kullanım
                kılavuzları işin gereği olan bilgi ve belgeler ile teslim
                etmeyi, her türlü ayıptan arî olarak yasal mevzuat gereklerine
                göre sağlam, standartlara uygun bir şekilde işi doğruluk ve
            ...
            <p>
                <span className="font-extrabold text-gray-900">9.4.</span>{" "}
            ...
            <p>
                <span className="font-extrabold text-gray-900">9.5.</span>{" "}
                ...
                yazılı olarak tüketiciye bildireceğini, 14 günlük süre içinde
                toplam bedeli ALICI’ya iade edeceğini kabul, beyan ve taahhüt
                eder.
            </p>
            <p>
                <span className="font-extrabold text-gray-900">9.6.</span>{" "}
                ALICI, Sözleşme konusu ürünün teslimatı için işbu Sözleşme’yi
                elektronik ortamda teyit edeceğini, herhangi bir nedenle
                sözleşme konusu ürün bedelinin ödenmemesi ve/veya banka
                kayıtlarında iptal edilmesi halinde, SATICI’nın sözleşme konusu
                ürünü teslim yükümlülüğünün sona ereceğini kabul, beyan ve
                taahhüt eder.
            </p>
            <p>
                <span className="font-extrabold text-gray-900">9.7.</span>{" "}
                ALICI, Sözleşme konusu ürünün ALICI veya ALICI’nın gösterdiği
                adresteki kişi ve/veya kuruluşa tesliminden sonra ALICI&apos;ya
                ait kredi kartının yetkisiz kişilerce haksız kullanılması
                sonucunda sözleşme konusu ürün bedelinin ilgili banka veya
                finans kuruluşu tarafından SATICI&apos;ya ödenmemesi halinde,
                ALICI Sözleşme konusu ürünü 3 gün içerisinde nakliye gideri
                SATICI’ya ait olacak şekilde SATICI’ya iade edeceğini kabul,
                beyan ve taahhüt eder.
            </p>
            <p>
                <span className="font-extrabold text-gray-900">9.8.</span>{" "}
                ...
                teslim edemez ise, durumu ALICI&apos;ya bildireceğini kabul,
                ...
                ertelenmesini SATICI’dan talep etme hakkını haizdir. ALICI
            ...
            <p>
                <span className="font-extrabold text-gray-900">9.9.</span>{" "}
                SATICININ, ALICI tarafından siteye kayıt formunda belirtilen
                veya daha sonra kendisi tarafından güncellenen adresi, e-posta
                adresi, sabit ve mobil telefon hatları ve diğer iletişim
                bilgileri üzerinden mektup, e-posta, SMS, telefon görüşmesi ve
                diğer yollarla iletişim, pazarlama, bildirim ve diğer amaçlarla
            ...
            <p>
                <span className="font-extrabold text-gray-900">9.10.</span>{" "}
                ALICI, sözleşme konusu mal/hizmeti teslim almadan önce muayene
            ...
            <p>
                <span className="font-extrabold text-gray-900">9.11.</span>{" "}
                ALICI ile sipariş esnasında kullanılan kredi kartı hamilinin
            ...
            <p>
                <span className="font-extrabold text-gray-900">9.12.</span>{" "}
                ALICI, SATICI’ya ait internet sitesine üye olurken verdiği
                kişisel ve diğer sair bilgilerin gerçeğe uygun olduğunu,
                SATICI’nın bu bilgilerin gerçeğe aykırılığı nedeniyle uğrayacağı
                tüm zararları, SATICI’nın ilk bildirimi üzerine derhal, nakden
                ve defaten tazmin edeceğini beyan ve taahhüt eder.
            </p>
            <p>
                <span className="font-extrabold text-gray-900">9.13.</span>{" "}
            ...
            <p>
                <span className="font-extrabold text-gray-900">9.14.</span>{" "}
                ...
                zorlaştırıcı faaliyet (spam, virus, truva atı, vb.) işlemlerde
                bulunamaz.
            </p>
            <p>
                <span className="font-extrabold text-gray-900">9.15.</span>{" "}
                SATICI’ya ait internet sitesinin üzerinden, SATICI’nın kendi
                kontrolünde olmayan ve/veya başkaca üçüncü kişilerin sahip
            ...
            <p>
                <span className="font-extrabold text-gray-900">9.16.</span> İşbu
                sözleşme içerisinde sayılan maddelerden bir ya da birkaçını
                ihlal eden üye işbu ihlal nedeniyle cezai ve hukuki olarak
            ...
            <p>
                <span className="font-extrabold text-gray-900">10.1.</span>{" "}
                ALICI; mesafeli sözleşmenin mal satışına ilişkin olması
                ...
                sunumuna ilişkin mesafeli sözleşmelerde ise, bu süre sözleşmenin
            ...
            <p>
                <span className="font-extrabold text-gray-900">10.2.</span>{" "}
                Cayma hakkının kullanılması için 14 (ondört) günlük süre içinde
                SATICI&apos; ya iadeli taahhütlü posta, faks veya eposta ile
            ...
            <p>
                <span className="font-extrabold text-gray-900">a)</span> 3.
            ...
            <p>
                <span className="font-extrabold text-gray-900">b)</span> İade
                formu,
            </p>
            <p>
                <span className="font-extrabold text-gray-900">c)</span> İade
                edilecek ürünlerin kutusu, ambalajı, varsa standart aksesuarları
                ile birlikte eksiksiz ve hasarsız olarak teslim edilmesi
                gerekmektedir.
            </p>
            <p>
                <span className="font-extrabold text-gray-900">d)</span> SATICI,
            ...
            <p>
                <span className="font-extrabold text-gray-900">e)</span> ALICI’
                nın kusurundan kaynaklanan bir nedenle malın değerinde bir
            ...
            <p>
                <span className="font-extrabold text-gray-900">f)</span> Cayma
            ...
            <p>
                ...
                teslim edildikten sonra başka ürünlerle karışan vedoğası gereği
                ...
                hizmetler veya tüketiciye anında teslim edilen gayrimaddi
                ...
                tarafından açılmış olması halinde iadesi Yönetmelik gereği
            ...
            <p>
                <span className="font-extrabold text-gray-900">a)</span> 6502
            ...
            <p>
                <span className="font-extrabold text-gray-900">b)</span> Değeri
                3.000,00(üçbin)TL’ nin altında bulunan uyuşmazlıklarda il
                tüketici hakem heyetlerine,
            </p>
            <p>
                <span className="font-extrabold text-gray-900">c)</span>{" "}
                Büyükşehir statüsünde bulunan illerde ise değeri 2.000,00
            ...
            <p>
                ...
                sayılır. SATICI, siparişin gerçekleşmesi öncesinde işbu
